...
class OldNotification extends State<OldNotificationScreen>{
                                          ...
                                          Expanded(child: Column(
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  Expanded(child:  Text(
                                                    list_notification.isEmpty?"":list_notification[position].userType,
                                                    style: Apptextstyle.lable.copyWith(fontWeight: FontWeight.w600),
                                                  ),),
                                                  Text(
                                                      list_notification.isEmpty?"":list_notification[position].createdAt.toString(),
  ...
  void getnotification()async {
    ...
    print(driverid);
    NotificationList login= await api.getNotification(token,driverid,"DRV","OLD");
    if(login.message=="Ok"){
      setState(() {
